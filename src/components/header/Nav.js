    ...
    return (
        <div className="nav">
            <ul className="nav-group">
                <NavLink to="/" exact activeStyle={{background: '#8E311A'}}>Home</NavLink>
                <NavLink to="/about" exact activeStyle={{background: '#8E311A'}}>About</NavLink>
                <NavLink to="/storymode" exact activeStyle={{background: '#8E311A'}}>Story Mode</NavLink>
